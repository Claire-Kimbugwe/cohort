...
def sort_by_cohort(filename):
    ...
    for line in file:
        ...
        if line_word[4] == "Fall 2015":
            name = line_word[0]+ " " + line_word[1]
            fall_15.append(name)
        if line_word[4] == "Winter 2016":
            name = line_word[0]+ " " + line_word[1]
            winter_16.append(name)
        if line_word[4] == "Spring 2016":
            name = line_word[0]+ " " + line_word[1]
            summer_16.append(name)
        if line_word[4] == "Summer 2016":
            name = line_word[0]+ " " + line_word[1]
    ...
    all_students.extend([fall_15, winter_16, summer_16,
                     spring_16, ghosts])
